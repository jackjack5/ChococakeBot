...
#ifdef _WIN32
#define GAMERECORDFILE "bwapi-data\\write\\ChococakeBot_GameRecord.dat"
#define GAMELOGFILE "bwapi-data\\write\\ChococakeBot_LastGameLog.dat"
#define GAMERECORDFILE_READ "bwapi-data\\read\\ChococakeBot_GameRecord.dat"
#define ISREADMAP true
#define READMAPFUNC BWTA::readMap();
#else
#define GAMERECORDFILE "bwapi-data/write/ChococakeBot_GameRecord.dat"
#define GAMELOGFILE "bwapi-data/write/ChococakeBot_LastGameLog.dat"
#define GAMERECORDFILE_READ "bwapi-data/write/ChococakeBot_GameRecord.dat"
#define ISREADMAP false
#define READMAPFUNC "no readmapfunc is necessary. this sentence is dummy";
#endif
